...
import { MintNftParams, MintParams } from "./assets/nft.types";
...
export class WalletService {
    ...
    async createNftFactory(params: MintNftParams, privKey: string): Promise<string> {
        return this.nftService.createNftFactory(params, privKey);
    }

    async createNft(params: MintParams, privKey: string): Promise<string> {
        return this.nftService.createNft(params, privKey);
    }
